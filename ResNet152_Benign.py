...
def train_and_evaluate_model(train_dir, dataset_name):
    ...
    # Save model
    # TODO: Rename Model
    model.save(f'{dataset_name}_benign_ResNet152_.h5')
    ...
    plt.tight_layout()
    # TODO: Rename Figure
    plt.savefig(f'{dataset_name}_benign_ResNet152_ACC&Loss.png')
    plt.close()
    ...
    plt.tight_layout()
    # TODO: Rename Figure
    plt.savefig(f'{dataset_name}_benign_ResNet152_Roc.png')
    plt.close()
