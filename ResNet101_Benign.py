...
def train_and_evaluate_model(train_dir, dataset_name):
    ...
    # Save model
    # TODO: Rename Model
    model.save(f'{dataset_name}_benign_ResNet101_.h5')
    ...
    plt.tight_layout()
    # TODO: Rename Figure
    plt.savefig(f'{dataset_name}_benign_ResNet101_ACC&Loss.png')
    plt.close()
    ...
    plt.tight_layout()
    # TODO: Rename Figure
    plt.savefig(f'{dataset_name}_benign_ResNet101_Roc.png')
    plt.close()


# Batch process for each dataset (40X, 100X, 200X, 400X)
# TODO: set train_dir
base_dir = r'D:\down\pythonProject\output-new\benign'
